...
$site_top = "https://keiwork.jp";

//管理者のメールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "info@k-bank.jp,nagano@55298.jp,mj77jp@yahoo.co.jp,tamura@hs-web.co.jp,kwork.ueda@gmail.com,hero.born.1.7@gmail.com,kwork.ueda@gaias.co.jp";
...
$refrom_name = "軽ワークへのお問い合わせありがとうございます";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "軽ワークへのお問い合わせありがとうございます";
...
この度は当店へお問い合わせ頂き、誠にありがとうございます。
お問合せ内容の方確認して、折り返し担当スタッフよりお電話させていただきます。
少々お待ちくださいませ。

お電話は、軽ワーク「0268-71-0145」の番号でおかけいたします。
どうぞ宜しくお願いいたします。
...
function copyright(){
	echo '<a style="display:block;text-align:center;margin:15px 0;font-size:11px;color:#aaa;text-decoration:none" href="https://econori.jp/lp/" target="_blank">- 定額エコノリくん -</a>';
}
//----------------------------------------------------------------------
//  関数定義(END)
//----------------------------------------------------------------------
